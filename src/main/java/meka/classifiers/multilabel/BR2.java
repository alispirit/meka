...
/**
 * BR2.java - The Binary Relevance Method.
 * The standard baseline Binary Relevance method (BR2) -- create a binary problems for each label and learn a model for them individually.
 * See also <i>BR2</i> from the <a href=http://mulan.sourceforge.net>MULAN</a> framework
...
public class BR2 extends ProblemTransformationMethod implements MultiLabelDrawable {
