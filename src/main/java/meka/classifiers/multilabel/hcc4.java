...
//                    }
                ...
                if(mosbat > manfi){
                    int a =mosbat-manfi > help[j].numInstances()?help[j].numInstances():mosbat-manfi;
                    for(int t=0;t<a;t++){
                        tempdata[j].add(help[j].instance(t));
                    }
                }
//                System.out.println("\n............");
            }
//            System.out.println("j is :"+j+" hole data : "+tempdata[j].numInstances());
//            System.out.println(": "+mosbat+manfi);
//            System.out.println("mosbat : "+mosbat+"\nmanfi :"+manfi);
            if (getDebug())
